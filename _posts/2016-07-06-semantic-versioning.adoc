...
TIP: Except for the build.gradle, you can use the exact copy of all files http://www.github.com/tonymkhael/semantic-versioning[in this public repository], as those files do not change much and they only exist to bootstrap your gradle setup.
